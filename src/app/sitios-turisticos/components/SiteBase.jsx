...
import SiteMapIndividual from "./SiteMapIndividual"
        ...
        <div className="flex flex-col gap-8">
            ...
            <div className="mt-12 sm:mt-16">
                ...
                <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-start">
                    ...
                    <div className="flex-1 w-full">
                        <div 
                            className={`w-full h-96 md:h-[500px] rounded-2xl border border-white/25 bg-white/5 overflow-hidden animate-fade-in-up ${isAnimationReady ? 'animate-enter-active' : ''}`}
                            style={{ transitionDelay: '0.6s' }}
                        >
                            <SiteMapIndividual site={site} />
                        </div>
                    </div>
                </div>
            </div>
